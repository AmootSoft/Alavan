...
```bash
curl --location 'https://service.alavan.ai/api/v1/Model/SpellCorrection' \
...
url = "https://service.alavan.ai/api/v1/Model/SpellCorrection"
headers = {
...
const url = "https://service.alavan.ai/api/v1/Model/SpellCorrection";
