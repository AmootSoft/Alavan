...
```bash
curl --location 'https://service.alavan.ai/api/v1/model/ObjectDetection' \
...
if not os.path.exists(file_path):
    ...
    url = "https://service.alavan.ai/api/v1/model/ObjectDetection"
    headers = {
...
fetch("https://service.alavan.ai/api/v1/model/ObjectDetection", {
  method: "POST",
  headers: {
    "Authorization": "Bearer توکن دریافتی از پرتال آلاوان",
    ...form.getHeaders()
