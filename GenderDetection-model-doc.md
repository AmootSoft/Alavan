...
```bash
curl --location 'https://service.alavan.co.ir/api/v1/model/GenderDetection' \
...
if not os.path.exists(file_path):
    ...
    url = "https://service.alavan.co.ir/api/v1/model/GenderDetection"
    headers = {
...
fetch("https://service.alavan.co.ir/api/v1/model/GenderDetection", {
  method: "POST",
  headers: {
    "Authorization": "Bearer توکن دریافتی از پرتال آلاوان",
    ...form.getHeaders()
