...
```bash
curl --location 'https://service.alavan.ai/api/v1/Phishing/CreateList' \
...
url = "https://service.alavan.ai/api/v1/Phishing/CreateList"
headers = {
...
const url = "https://service.alavan.ai/api/v1/Phishing/CreateList";
