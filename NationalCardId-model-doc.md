# نحوه استفاده از API مدل استخراج اطلاعات کارت ملی
...
```bash
curl --location 'https://service.alavan.co.ir/api/v3/model/NationalCardId' \
...
if not os.path.exists(file_path):
    ...
    url = "https://service.alavan.co.ir/api/v3/model/NationalCardId"
    headers = {
...
fetch("https://service.alavan.co.ir/api/v3/model/NationalCardId", {
  method: "POST",
  headers: {
    "Authorization": "Bearer توکن دریافتی از پرتال آلاوان",
    ...form.getHeaders()
