...
```bash
curl --location 'https://service.alavan.ai/api/v1/SmsValidation/SmsClassification' \
...
url = "https://service.alavan.ai/api/v1/SmsValidation/SmsClassification"
headers = {
...
const url = "https://service.alavan.ai/api/v1/SmsValidation/SmsClassification";
