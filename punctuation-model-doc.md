...
```bash
curl --location 'https://service.alavan.ai/api/v1/Model/Punctuation' \
...
url = "https://service.alavan.ai/api/v1/Model/Punctuation"
headers = {
...
const url = "https://service.alavan.ai/api/v1/Model/Punctuation";
