...
```bash
curl --location 'https://service.alavan.co.ir/api/v3/Model/Emotion' \
...
url = "https://service.alavan.co.ir/api/v3/Model/Emotion"
headers = {
...
```javascript
const url = "https://service.alavan.co.ir/api/v3/Model/Emotion";
