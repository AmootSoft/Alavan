...
```bash
curl --location 'https://service.alavan.ai/api/v1/Model/Emotion' \
...
url = "https://service.alavan.ai/api/v1/Model/Emotion"
headers = {
...
```javascript
const url = "https://service.alavan.ai/api/v1/Model/Emotion";
