...
```bash
curl --location 'https://service.alavan.ai/api/v1/Model/ImageCaptioning' \
...
if not os.path.exists(file_path):
    ...
    url = "https://service.alavan.ai/api/v1/Model/ImageCaptioning"
    headers = {
...
const url = 'https://service.alavan.ai/api/v1/Model/ImageCaptioning';
